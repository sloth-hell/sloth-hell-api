package com.slothhell.api.domain.meeting.web.web
...
class MeetingControllerTest : BaseControllerTest() {
	...
	@Test
	@DisplayName("[GET /meeting/{meetingId}] 존재하는 meetingId로 요청 시 200 응답")
	fun givenExistingMeetingId_whenGetMeeting_thenRetrieveMeetingInfo() {
	...
	@Test
	@DisplayName("[GET /meeting] meeting 목록 요청 시 200 응답")
	fun givenMeetingsExist_whenGetMeetings_thenRetrieveMeetings() {
		val invalidKakaoChatUrl = "https://open.kakao.com/o/1234567"
		val createMeetingRequest = CreateMeetingRequest(
			title = "모각코 4인팟 모집",
			location = "스타벅스 과천DT점",
